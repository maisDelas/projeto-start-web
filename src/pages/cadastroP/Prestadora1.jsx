...
function CadastroUnificado() {
  ...
  const validateStep2 = () => {
    ...
    if (!formData.experience.trim()) newErrors.experience = "A experiência é obrigatória";
    if (!formData.portfolioFiles && !formData.portfolioLink.trim())
      newErrors.portfolio = "Adicione um portfólio";
    setErrors(newErrors);
    return Object.keys(newErrors).length === 0;
  };
